...
export const operations: Person[] = [
  {
    ...
    year: 'Third year',
    bio:
      'My main research focus is in natural language processing and social computing. In my free time, I like to watch new things and cook. I have a cool cat that is not interested in AI.',
    picture: Chris,
  },
  {
    role: 'Event Lead',
  ...
  },
  {
    ...
    year: 'Third year',
    bio:
      'I am a Sophomore CS major in Warren. I was a research intern at the Data Mining Lab. I like to play Go (board game), kpop dance, and AI. Still to this day fascinated by Alpha Go',
    picture: Judy,
  },
  {
    role: 'Event Lead',
    ...
    year: 'Fourth year',
    bio:
      'I am a CS major who likes programming, AI, video games, and any show, movie, anime with a thriller tag on it. I want to try food from different cultures.',
    picture: Satyam,
  },
  {
    role: 'Event Lead',
  ...
  },
  {
    ...
    year: 'First year',
    bio:
      "Hey all, I'm Arth. I'm a first-year Math-CS major interested in AI/ML, applied math, and web and automation development. I'm also interested in global politics, and in my spare time I like playing video games and watching anime.",
    picture: Arth,
  },
  {
    role: 'Event Lead',
...
export const dev: Person[] = [
  {
    ...
    year: 'Third year',
    bio:
      'Hi! I’m Joshua and I’m a Cognitive Science major from the Bay Area. At ACM AI, I’m excited to make AI more understandable and accessible to students. In my free time, I enjoy cooking, watching TV shows, and playing games such as Hollow Knight and Celeste',
    picture: Joshua,
  },
  {
    role: 'Developer',
    ...
    year: 'Third year',
    bio:
      'Hi! I’m Yuru and I’m currently a third year majoring in Mathematics & Computer Science.  I really enjoy watching movies, going to karaoke, and cooking during free time. And I love Boba!!!',
    picture: Yuru,
  },
  {
    role: 'Developer',
...
export const external: Person[] = [
  {
    ...
    year: 'Third year',
    bio:
      "Hi! My name's Karthik, and I'm currently a third-year double majoring in Data Science and General Biology. I'm really interested in bioinformatics, and the applications of AI to biology. For fun, I enjoy running, playing tennis, playing the guitar, and hanging out with my dog.",
    picture: Karthik,
  },
  {
    ...
    year: 'Third year',
    bio:
      'Swimming, running, playing league, eating fast food, and writing code',
    picture: Dennis,
  },
  {
    role: 'Marketing Coordinator',
