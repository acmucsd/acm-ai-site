...
export const runMatch = async (dimensionID:nanoid, matchID: nanoid): Promise<any> => {
  return new Promise((resolve, reject) => {
    axios.post(competitionAPI+ `/dimensions/${dimensionID}/match/${matchID}/run`).then((res: AxiosResponse) => {
      resolve(res);
    }).catch((error) => {
      reject(error);
    })
...
export const stopMatch = async (dimensionID:nanoid, matchID: nanoid): Promise<any> => {
  return new Promise((resolve, reject) => {
    axios.post(competitionAPI+ `/dimensions/${dimensionID}/match/${matchID}/stop`).then((res: AxiosResponse) => {
      resolve(res);
    }).catch((error) => {
      reject(error);
    })
...
export const removeMatch = async (dimensionID: nanoid, matchID: nanoid): Promise<any> => {
  return new Promise((resolve, reject) => {
    axios.delete(competitionAPI+ `/dimensions/${dimensionID}/match/${matchID}`).then((res: AxiosResponse) => {
      resolve(res);
    }).catch((error) => {
      reject(error);
    })
