...
/**
 * Modular component that renders a competition submission details.
 * This is used as part of a submission log preview in the 
 * Competitions Portal page in the 'My Team' tab as well as the 
 * Submissions Log page.
 * 
 * @param {any} data  The submission entry, dereferenced using data.entry
 * 
 * An entry inherits the competitionEntry interface:
 * 
...
const SubmissionEntryCard = (data: any) => {
  ...
  // the upload status of the entry
  let status = '?';
      ...
      >
        ...
        <section className="submissionDetailsSection">
          ...
          <div className="submissionDetailsRow">
            ...
            <span>
              {/* Current competitionEntry schema doesn't have way to add username to identify uploader. 
                * A simple solution is to insert the username into the tag list as the first element*/}
          ...
          <div className="submissionDetailsRow">
            ...
            <p className="submissionStatus"
              style={{
                backgroundColor: status == "uploading" ? "rgb(18, 113, 255)" :
