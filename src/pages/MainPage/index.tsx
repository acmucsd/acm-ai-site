      ...
      <div className='Main'>
        ...
        <div>
          <div className='main-section'>
            ...
            <p>Our goals are to help build a community of AI enthusiasts at UCSD and connect that community to the broader AI network. We also strive to keep AI fun and accessible to all. We want to help you navigate your path around the complex world of AI through workshops, competitions, networking events and more!</p>
            <p>Don't know where to start? Scroll down or go to our <a href="/#events">events</a></p>
          </div>
          <div className='main-section'>
            ...
            <p>Make sure to also <Link to='/register'>register</Link> an account with us! That way we can reach out to you about new opportunities and you can enter our exciting competitions</p>
            <h3>Joining Us</h3>
          ...
          <div className='main-section' id='events'>
            <h2 className='statement' id='learn-ai'>Upcoming Events!</h2>
            <p>These are our upcoming events on workshops, competitions, networking and more!</p>
            <Row gutter={[24, 24]} justify='center'>
              {eventData.map((event) => {
                return <Col><EventCard event={event}/></Col>
              })}
            </Row>
          </div>
        </div>
