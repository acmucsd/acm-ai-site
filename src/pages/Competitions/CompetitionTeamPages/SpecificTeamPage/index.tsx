...
const CompetitionSpecificTeamPage = () => {
  ...
  let { competitionName, teamName } = useParams<{
      ...
      <div className="CompetitionSpecificTeamPage">
        ...
        {isRegistered ? (
          <div className="main-section">
              ...
              {teamInfo.teamName && (
                <div
                  style={{
                    ...
                    width: '2.85rem',
                    height: '2.85rem',
                    background: `linear-gradient(30deg, ${genColor(
                      teamInfo.teamName
                    )}, ${genColor(`${teamInfo.teamName}_abcs`)})`,
                    marginRight: '0.75rem',
                  }}
                ></div>
              )}
            ...
            <h3>
              <span className="subheader">Members</span>
            </h3>
            <div>
            ...
            {isMyTeam && (
              <>
                ...
                <Button
                  onClick={() => {
                    history.push(
                      path.join('/competitions', competitionName, 'upload')
                    );
                  }}
                >
                  Create Submission
                ...
                <br />
                <p>
                  Click a row to see details about the submission and watch
                  replays. The latest verified submission is the one in the
