...
export const projects: Project[] = [
    {
        ...
        "cover": "https://s.yimg.com/os/creatr-uploaded-images/2020-06/812a6680-b085-11ea-b7fd-7591620edf6b",
        "tags": ["GAN", "Image Generation", "Image Processing", "Image", "Deep Learning"],
        "description": "We are using GAN architecture to take in human images and \"cartoonify\" them to create a simpsons version of them. To do this, we utilized Pytorch, TensorFlow, and other Python libraries.",
    ...
    },
    {
        ...
        "cover": "https://packardcommunications.com/wp-content/uploads/2019/02/iStock-496650660.jpg",
        "tags": ["GAN", "Deep Learning", "Natural Language Processing"],
        "description": "We are blending prosody information of different accented speakers, to generate a text-to-speech model for different accents. We use GANs to mix and generate prosodies, and use Tacotron to synthesize audios.",
        "github": "",
    ...
    },
    {
        ...
        "cover": "https://www.psychologicalscience.org/redesign/wp-content/uploads/2018/04/PAFF_040918_emotionspectrum2-1024x622.jpg",
        "tags": ["Image Processing", "Image", "Classification"],
        "description": "We are working on a model that is able to recognize the emotion from one’s face image. To accomplish this, we use Tensorflow Keras to create this system.",
    ...
    },
    {
        ...
        "cover": "https://library.sportingnews.com/styles/crop_style_16_9_mobile_2x/s3/2021-08/stephencurry-cropped_10flibuo4oylm1auxz5yobh7u0.jpg?itok=rd0nrd9I",
    ...
    },
    {
        ...
        "description": "Our team uses a convolutional neural network framework to create an image processing model that recognizes hand gestures as American Sign Language letters.",
    ...
    },
    {
        ...
        "cover": "https://abcbirds.org/wp-content/uploads/2021/07/Blue-Jay-on-redbud-tree-by-Tom-Reichner_news.png",
        "tags": ["Image Processing", "Deep Learning", "Image Classification", "Computer Vision"],
        "description": "Our team has built a convolutional neural network that has trained on a dataset containing 325 different species of birds and can classify them into the correct species they are a part of.",
    ...
    },
    {
        ...
        "cover": "https://camo.githubusercontent.com/b2d59376383f241e7695e8fcba13fb096db80d805d808da46c8255ea2c5da588/68747470733a2f2f6d2e6d656469612d616d617a6f6e2e636f6d2f696d616765732f492f3631583654546f4534664c2e5f41435f53583637395f2e6a7067",
        "tags": ["Reinforcement Learning"],
        "description": "This project was built with the aim of using various model-free reinforcement learning algorithms to train a car how to drive around a race track.",
    ...
    },
    {
        ...
        "tags": ["Reinforcement Learning"],
        "description": "Create a custom OpenAI gym environment for flappy bird and train a stable-baselines3 PPO model to play",
    ...
    },
    {
        ...
        "tags": ["Image Processing", "Deep Learning", "Image Segmentation", "Computer Vision"],
        "description": "Our team worked on learning CNNs, the ML pipeline, image preprocessing, and deep learning-based methods for image segmentation.",
    ...
    },
    {
        ...
        "tags": ["Natural Language Processing", "Sentiment Analysis", "Classification"],
        "description": "Our team worked on building an RNN for a NLP based project. The goal of this project was to take in a sentence and classify it as either politically liberal or conservative. The model was trained on Reddit datasets",
        "github": "https://huggingface.co/spaces/joonkim/bert-political-sentiment-analysis/tree/main",
    ...
    },
    {
        ...
        "tags": ["Natural Language Processing", "Sentiment Analysis", "Classification"],
        "description": "The legitimacy of the Supreme Court and uproar over Roe v. Wade towards the later half of 2022 has been debated heavily. Given the uses of AI, can we use machine learning to predict the outcomes of Supreme Court cases?",
    ...
    },
    {
        ...
        "cover": "https://media.istockphoto.com/id/1278019531/vector/victim-of-cyber-bullying.jpg?s=612x612&w=0&k=20&c=DyMvMsOGJJ-Q54LFpGsiH86Yaabfu43LuvCv_vKVHj0=",
        "tags": ["Natural Language Processing", "Sentiment Analysis", "Classification"],
    ...
    },
    {
        ...
        "cover": "https://raw.githubusercontent.com/acmucsd-projects/sp23-ai-team-1/main/src/img/MBTI_Predictor.png",
        "tags": ["Natural Language Processing", "Sentiment Analysis", "Classification"],
        "description": "MBTI, or Myers-Briggs Type Indicator, is a way to classify different personality types based on four categories: introversion(I)/extraversion(E), sensing(S)/intuition(N), thinking(T)/feeling(F), and judging(J)/perceiving(P).  Due to the the long and tedious process that it takes to finish the test, we decided to create a model that can predict a person’s MBTI based on their tweets. This process takes just a fraction of the time as compared to the original MBTI test, allowing users to figure out their personality more efficiently.",
